...
jq 'del(.contracts.router)' ../../src/assets/config.json > temp.json && mv temp.json ../../src/assets/config.json
cp target/wasm32-unknown-unknown/release/router.wasm ../../src/assets/wasm/
cd ../../
npm test
